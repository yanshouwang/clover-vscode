...
import { flatMap, isDartSDKFromFlutter, notUndefined } from "../../shared/util";
import { extractFlutterSdkPathFromPackagesFile, fsPath, getSdkVersion, hasPubspec, projectReferencesFlutterSdk } from "../../shared/util/fs";
import { resolvedPromise } from "../../shared/util/promises";
import { processBazelWorkspace, processDartSdkRepository, processFuchsiaWorkspace } from "../../shared/util/workspace";
import { envUtils, getAllProjectFolders, getDartWorkspaceFolders } from "../../shared/vscode/util";
import { WorkspaceContext } from "../../shared/workspace";
import { Analytics } from "../analytics";
import { config } from "../config";
import { ringLog } from "../extension";
import { getExcludedFolders, openLogContents, promptToReloadExtension, resolvePaths } from "../util";
...
export class SDKUtil {
    ...
    public async scanWorkspace(): Promise<WorkspaceContext> {
        ...
        return new WorkspaceContext(
            {
                dart: dartSDKPath,
                isDartSDKFromFlutter: !!dartSDKPath && isDartSDKFromFlutter(dartSDKPath),
